      ...
      <div className="relative group px-4 md:px-8">
        ...
        >
          {hotelsTops.map((hotel) => (
            <Link
              to={`/detailshotel/${hotel.hotelId}`}
              key={hotel.hotelId}
              className="flex-shrink-0 w-[220px] md:w-[260px] lg:w-[280px] h-[360px] flex flex-col justify-between rounded-xl border shadow hover:shadow-lg transition bg-white cursor-pointer"
            >
