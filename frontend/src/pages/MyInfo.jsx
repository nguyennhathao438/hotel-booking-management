  ...
  return (
    <>
      ...
      >
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-6 mb-4">
            <div className="relative">
              ...
              <button
                type="button"
                className="absolute right-4 top-2/3 -translate-y-1/2text-[#4b2e1f] text-sm font-medium hover:underline"
          ...
          {!isEdit && (
            <div className="text-center">
              <button
                className="bg-[#4b2e1f] hover:bg-[#6b4a38] text-white font-medium py-2 px-8 rounded-full transition-colors duration-300"
          ...
          {isEdit && (
            <div className="text-center gap-3 flex justify-center">
              <button
                className="bg-[#8d6e63] w-[150px] hover:bg-[#a17f66] text-white font-medium py-2 px-8 rounded-full transition-colors duration-300"
                onClick={() => setIsEdit(false)}
              >
                Hủy
              </button>
              <button
                className="bg-[#4b2e1f] w-[150px] hover:bg-[#6b4a38] text-white font-medium py-2 px-8 rounded-full transition-colors duration-300"
        ...
        {openFormPassword && (
          <ModelForm title="Đổi mật khẩu" onClose={handleCloseForm}>
            <div>
              <label className="block text-sm font-medium mb-1">
                Mật khẩu cũ
              </label>
            ...
            <div className="text-right mt-6">
              <button
                type="submit"
                className="bg-[#4b2e1f] hover:bg-[#6b4a38] text-white font-medium py-2 px-6 rounded-full transition-colors duration-300"
