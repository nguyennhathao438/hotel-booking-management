...
public enum ErrorCode {
    ...
    SERVICE_NOT_EXISTED(10020, "Dịch vụ không tồn tại", HttpStatus.NOT_FOUND),
    SERVICE_EXISTED(10020, "Dịch vụ đã tồn tại", HttpStatus.CONFLICT),
    ...
    REQUEST_HOTEL_EXISTED(1025, "Bạn đã có yêu cầu tạo khách sạn rồi", HttpStatus.CONFLICT);
